...
class ProdutoController {
    ...
    async cadastrar(req, res) {
        try {
            const dadosProduto = {...req.body, imagem: req.file ? req.file.filename : null}; // NEW: Dados do Body e Imagem (se file = salva ou null)
    ...
    async atualizar(req, res) {
        try {
            const dadosProduto = {...req.body}; // NEW: Dados do Body
            if (req.file) {dadosProduto.imagem = req.file.filename;} // NEW: Substituição
